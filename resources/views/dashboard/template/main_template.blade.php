...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('_dashboard/assets/css/argon-dashboard.css?v=2.0.6') }}" rel="stylesheet" />
    <link rel="stylesheet" href="{{ asset('_dashboard/assets/css/main.css') }}">
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <main class="main-content position-relative border-radius-lg main-site-template">
        <!-- Navbar -->
        <x-dashboard.navbar />
        <x-dashboard.aside-bar />

        <!-- End Navbar -->
        <div class="container-fluid py-4">
            <div class="row">
                <x-dashboard.home.total_visitors />
                <x-dashboard.home.likes_in_posts />
                <x-dashboard.home.revenue_generated />
                <x-dashboard.home.sales_revenue />
            </div>
            <div class="row mt-4">
                <div class="col mb-lg-0 mb-4">
                    <div class="card z-index-2 h-100">
                        <div class="card-header pb-0 pt-3 bg-transparent">
                            <h6 class="text-capitalize">Visualizações</h6>
    ...
    <script src="{{ asset('_dashboard/assets/js/close-aside-bar.js?v=2.0.4') }}"></script>
</body>
